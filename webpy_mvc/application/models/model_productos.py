...
'''
def insert_productos(nombre_producto,contenido,marca,precio):
    try:
        return db.insert('productos', nombre_producto=nombre_producto,contenido=contenido,marca=marca,precio=precio) # inserta un registro en producto
    except Exception as e:
...
'''
def update_productos(nombre_producto,contenido,marca,precio): # actualiza el email de personas que coincidan con el nombre
    try:
