...
'''
def insert_clientes(nombre_cliente,apellidos_cliente,tipo_cliente,calle_numero):
    try:
        return db.insert('clientes', nombre_cliente=nombre_cliente, apellidos_cliente=apellidos_cliente,tipo_cliente=tipo_cliente,calle_numero=calle_numero) # inserta un registro en producto
    except Exception as e:
...
'''
def update_clientes(nombre_cliente,apellidos_cliente,tipo_cliente,calle_numero): # actualiza los datos de la tabla clientes que coincidan con el nombre
    try:
