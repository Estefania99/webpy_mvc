...
class Insert:
    ...
    def POST(self):
        ...
        contenido = formulario['contenido'] # almacena el contenido escrito en el input
        ...
        config.model_productos.insert_productos(nombre_producto,contenido,marca,precio) # llama al metodo insert_datos y le paso los datos guardados
